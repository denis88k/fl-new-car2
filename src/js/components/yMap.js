...
function yandexiniti() {
	...
	function init() {
		...
		//     }
		// });
		// var myMap = new ymaps.Map("detail_report_map_child_1", {
		//     center: [54.995070, 82.832080],
		//     zoom: zoom_value,
		//     suppressMapOpenBlock: true,
		//     controls: []
		// }, {

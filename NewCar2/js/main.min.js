    ...
    selectInput.addEventListener('click', () => {
      ...
      options.forEach(option => {
        option.onclick = e => {
          ...
          const isBetween = checkboxBlock => selectFrom <= Number(checkboxBlock.dataset.from) && Number(checkboxBlock.dataset.from) <= selectTo || selectTo >= Number(checkboxBlock.dataset.to) && Number(checkboxBlock.dataset.to) >= selectFrom;

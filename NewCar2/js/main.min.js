...
/* harmony import */ var _mileage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mileage.js */ "./src/js/components/mileage.js");
/* harmony import */ var _owner_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./owner.js */ "./src/js/components/owner.js");
/* harmony import */ var _report_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./report.js */ "./src/js/components/report.js");
/* harmony import */ var _visibleBlockAndBtnShowMore_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./visibleBlockAndBtnShowMore.js */ "./src/js/components/visibleBlockAndBtnShowMore.js");
/* harmony import */ var _years_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./years.js */ "./src/js/components/years.js");
...
const showLastChat = chat => {
  setTimeout(() => {
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.addClass)(chatBlock[1], 'msg-show'); // 6
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.addClass)(chatBlock[2], 'msg-show'); // 7
    ...
    scrollChat(chat);
    (0,_report_js__WEBPACK_IMPORTED_MODULE_4__.resetReport)();
  }, 3800);
};
const hiddenLastChat = () => {
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeClass)(chatBlock[1], 'msg-show'); // 6
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeClass)(chatBlock[2], 'msg-show'); // 7
...
const resetActiveAllBlock = currentNumber => {
  for (let i = currentNumber + 1; i < chatLength - 2; i++) {
    ...
    msgBlocks.forEach(msgBlock => {
      ...
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeClass)(msgChatConsultant, 'msg-show');
    });
    // NOTE: блок CHOICE
    ...
    if (msgBlockMulti) {
      ...
      if (msgBlockMulti.querySelector('.years__block')) {
        ...
        (0,_years_js__WEBPACK_IMPORTED_MODULE_6__.resetYears)();
      }
      if (msgBlockMulti.querySelector('.mileage__block')) {
        console.log('mileage__block');
        (0,_mileage_js__WEBPACK_IMPORTED_MODULE_2__.resetMileage)();
      }
      if (msgBlockMulti.querySelector('.owner__block')) {
        console.log('owner__block');
        (0,_owner_js__WEBPACK_IMPORTED_MODULE_3__.resetOwner)();
      }
      // switch (i) {
      // 	case 1:
      // 		resetYears();
...
const chat2 = () => {
  ...
  msgBlocks.forEach((msgBlock, index) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.addClass)(msgConsult, 'msg-show');
        // если это не первая секция чата, то плавный скролл на высоту сообщения от консультанта
  ...
  setTimeout(() => {
    if (msgBlockMulti) {
      if (msgBlockMulti.querySelector('.years__block')) {
        console.log('years__block');
        (0,_years_js__WEBPACK_IMPORTED_MODULE_6__.yearsShowSelect)();
        (0,_checkbox_js__WEBPACK_IMPORTED_MODULE_0__.checkboxComponent)('years');
        (0,_visibleBlockAndBtnShowMore_js__WEBPACK_IMPORTED_MODULE_5__.blockVisible)('.years__checkbox-block', '.years__show-more', 6, 'Показать все поколения');
        document.querySelector('.years__show-more').addEventListener('click', _visibleBlockAndBtnShowMore_js__WEBPACK_IMPORTED_MODULE_5__.btnShowMoreClick.bind(null, '.years__checkbox-block', 6, 'Показать все поколения'));
      }
      if (msgBlockMulti.querySelector('.mileage__block')) {
        console.log('mileage__block');
        (0,_mileage_js__WEBPACK_IMPORTED_MODULE_2__.mileageInput)();
      ...
      if (msgBlockMulti.querySelector('.owner__block')) {
        ...
        (0,_owner_js__WEBPACK_IMPORTED_MODULE_3__.owner)();
      }
    }
  ...
  if (msgBlockChoice) {
    ...
    const blockChoiceClick = e => {
      ...
      if ((0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(e.target, 'choice-car__btn-next') || (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(e.target, 'choice-car__btn-prev')) {
        return;
      }
...
/* harmony import */ var _components_mileage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/mileage.js */ "./src/js/components/mileage.js");
/* harmony import */ var _components_owner_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/owner.js */ "./src/js/components/owner.js");
/* harmony import */ var _components_stickyConsultant_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/stickyConsultant.js */ "./src/js/components/stickyConsultant.js");
/* harmony import */ var _components_visibleBlockAndBtnShowMore_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/visibleBlockAndBtnShowMore.js */ "./src/js/components/visibleBlockAndBtnShowMore.js");
/* harmony import */ var _components_years_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/years.js */ "./src/js/components/years.js");
...
window.addEventListener('scroll', _components_stickyConsultant_js__WEBPACK_IMPORTED_MODULE_4__["default"]);
// NOTE: =================MODEL CHOICE===============
// ========================================
...
(0,_components_visibleBlockAndBtnShowMore_js__WEBPACK_IMPORTED_MODULE_5__.blockVisible)('.report__info-block', '.report__info-btn', 3, 'Показать все сведения');
document.querySelector('.report__info-btn').addEventListener('click', _components_visibleBlockAndBtnShowMore_js__WEBPACK_IMPORTED_MODULE_5__.btnShowMoreClick.bind(null, '.report__info-block', 3, 'Показать все сведения'));
// // для обнуления вызывать: =>
// resetReport()

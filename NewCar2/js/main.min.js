...
const btnShowMore = function (blocksShow, btn) {
  let btnText = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  let countBlockVisible = arguments.length > 3 ? arguments[3] : undefined;
  let textHidden = arguments.length > 4 ? arguments[4] : undefined;
  let textOpen = arguments.length > 5 ? arguments[5] : undefined;
